...
export function SearchResultsClient({ searchQuery }: SearchResultsClientProps) {
  ...
  const products = [
    ...
    {
      id: 7,
      name: "Madgetech Hitemp140 High Temperature DataLogger",
      price: "$750-900",
      minOrder: "1 units",
      supplier: "Madgetech",
      verified: true,
      ...
      image: "/logger/07.png",
      badges: ["FCC", "CE"],
      attributes: ["High Temperature", "Real-time Monitoring", "USB"],
    },
    {
      id: 8,
      name: "LogTag USRIC-4 Single Use USB Temperature Recorder",
      price: "$50-75",
      minOrder: "10 units",
      supplier: "LogTag",
      verified: false,
      ...
      image: "/logger/08.png",
      badges: ["CE"],
      attributes: ["Single Use", "Waterproof", "USB"],
    },
  ];
